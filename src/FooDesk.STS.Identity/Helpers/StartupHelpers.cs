...
using SendGrid;
using FooDesk.STS.Identity.Configuration;
using FooDesk.STS.Identity.Configuration.ApplicationParts;
using FooDesk.STS.Identity.Configuration.Constants;
using FooDesk.STS.Identity.Configuration.Interfaces;
using FooDesk.STS.Identity.Helpers.Localization;
using FooDesk.STS.Identity.Services;
using System.Linq;
using Skoruba.IdentityServer4.Admin.EntityFramework.Interfaces;
using FooDesk.Admin.EntityFramework.MySql.Extensions;
using FooDesk.Admin.EntityFramework.PostgreSQL.Extensions;
using FooDesk.Admin.EntityFramework.Shared.Configuration;
using FooDesk.Admin.EntityFramework.SqlServer.Extensions;
using Skoruba.IdentityServer4.Admin.EntityFramework.Helpers;

namespace FooDesk.STS.Identity.Helpers
{
