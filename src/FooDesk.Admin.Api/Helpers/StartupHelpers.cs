...
using FooDesk.Admin.Api.AuditLogging;
using FooDesk.Admin.Api.Configuration;
using FooDesk.Admin.Api.Configuration.ApplicationParts;
using FooDesk.Admin.Api.Configuration.Constants;
using FooDesk.Admin.Api.Helpers.Localization;
...
namespace FooDesk.Admin.Api.Helpers
{
