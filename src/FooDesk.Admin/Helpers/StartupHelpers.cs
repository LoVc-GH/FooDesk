...
using FooDesk.Admin.ExceptionHandling;
using FooDesk.Admin.Configuration;
using FooDesk.Admin.Configuration.ApplicationParts;
using FooDesk.Admin.Configuration.Constants;
using FooDesk.Admin.Configuration.Interfaces;
using Skoruba.IdentityServer4.Admin.EntityFramework.Interfaces;
using Skoruba.IdentityServer4.Admin.EntityFramework.Repositories;
using Skoruba.IdentityServer4.Admin.EntityFramework.Repositories.Interfaces;
using FooDesk.Admin.Helpers.Localization;
using System.Linq;
...
namespace FooDesk.Admin.Helpers
{
